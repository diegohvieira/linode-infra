...
# Create a Linode VPC. Ref: https://registry.terraform.io/providers/linode/linode/latest/docs/resources/vpc
...
# Create a Linode VPC subnet. Ref: https://registry.terraform.io/providers/linode/linode/latest/docs/resources/vpc_subnet
